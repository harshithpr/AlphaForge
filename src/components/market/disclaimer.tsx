...
export function Disclaimer() {
  return (
    <div className="flex items-start gap-3 border-t border-white/10 bg-zinc-950/80 px-4 py-3 text-xs leading-5 text-zinc-400 md:px-6">
      ...
      <p>
        AlphaForge AI is for educational research only and is not financial advice. Scores are
        general, impersonal research signals with visible assumptions, source links, risk notes,
